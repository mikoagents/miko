...
- Default Atmiko workflow skills copied into the isolated F1 home.
...
- The simulator recorded `gh pr create --title "Fix greeting typo" --base main` with a full summary, validation, issue link, and Atmiko marker.
