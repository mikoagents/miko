...
### Added
- Task cards show whether Fast mode is on, off, or unrecorded; Cursor sessions retain the selected setting in task history. ([#6](https://github.com/nexmoe/cyrus/pull/6))
