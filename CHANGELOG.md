...
### Added
- Use bracketed selectors consistently in issue descriptions: `[repos=frontend,backend]` now selects multiple repositories alongside `[agent=...]` and `[model=...]`. Existing repository selectors remain compatible.
