...
### Fixed
- GitHub task replies now identify the triggering comment or stay in its review thread. The request's reaction changes from eyes to thumbs-up when the reply is delivered successfully, or confused when the task fails.
