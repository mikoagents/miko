...
### Added
- Task cards show the recorded reasoning effort beside the model, including archived sessions. Codex reports the effective model and effort when starting or resuming a thread; older records display unknown.
