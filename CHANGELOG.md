...
### Fixed
- Cursor tasks now start with the current SDK, fixing a missing transport dependency and incompatible working-directory parameter. ([#6](https://github.com/nexmoe/cyrus/pull/6))
